...
namespace Microsoft.Azure.WebJobs.Script
{
    public class ScriptHost : JobHost
    {
        ...
        public static ScriptHost Create(IScriptHostEnvironment environment, IScriptEventManager eventManager,
            ScriptHostConfiguration scriptConfig = null, ScriptSettingsManager settingsManager = null, ILoggerFactoryBuilder loggerFactoryBuilder = null)
        {
            ScriptHost scriptHost = new ScriptHost(environment, eventManager, scriptConfig, settingsManager, loggerFactoryBuilder);
            try
            {
